 ...
 */
final class Version20201220133211 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE beneficiary ADD iban INT NOT NULL, DROP iban_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE beneficiary ADD iban_id INT DEFAULT NULL, DROP iban');
